...
public class IcebergOrder extends Order {
    ...
    public IcebergOrder(EnterOrderRq enterOrderRq,Security security,Broker broker,Shareholder shareholder) {
        this(enterOrderRq.getOrderId(), security, enterOrderRq.getSide(),
