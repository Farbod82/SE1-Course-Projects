...
public class StopOrderTest {
    ...
    void check_sorting_of_activated_sell_order_list(){
        ...
        orderHandler.handleEnterOrder(EnterOrderRq.createNewOrderRq(2, "ABC", 12, LocalDateTime.now(), Side.SELL,
                50, 15800, broker1.getBrokerId(), shareholder.getShareholderId(), 0, 0, 15799));
        orderHandler.handleEnterOrder(EnterOrderRq.createNewOrderRq(3, "ABC", 13, LocalDateTime.now(), Side.SELL,
                50, 15800, broker1.getBrokerId(), shareholder.getShareholderId(), 0, 0, 15797));
        orderHandler.handleEnterOrder(EnterOrderRq.createNewOrderRq(4, "ABC", 14, LocalDateTime.now(), Side.SELL,
                50, 15800, broker1.getBrokerId(), shareholder.getShareholderId(), 0, 0, 15798));
        orderHandler.handleEnterOrder(EnterOrderRq.createNewOrderRq(5, "ABC", 15, LocalDateTime.now(), Side.SELL,
